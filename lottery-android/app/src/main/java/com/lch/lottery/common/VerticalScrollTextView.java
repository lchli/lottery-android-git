...
public class VerticalScrollTextView extends RelativeLayout {
    ...
    private List<? extends Data> mDataSource;
    ...
    private void resetData() {
        ...
        Data normal = mDataSource.get(0);


        if (normal != null) {

            normal.bindView(mTvContentTop);
    ...
    private void autoSlider() {
        ...
        Data normal = mDataSource.get(mCurrentItemIndex);
        ...
        Data next = mDataSource.get(mCurrentItemIndex);


        if (next != null) {
            next.bindView(mTvContentBottom);
        }
    ...
    public void setDataSource(List<? extends Data> dataSource) {
